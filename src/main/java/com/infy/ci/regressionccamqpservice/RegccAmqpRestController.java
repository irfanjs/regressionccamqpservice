package com.infy.ci.regressionccamqpservice;
...
@Component
@Configuration
public class RegccAmqpRestController {
	...
	private final Logger logger = LoggerFactory.getLogger(RegccAmqpRestController.class);
	

	@RequestMapping(value = "/{projectid}/regcc/aggregate", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/regcc/modulewise", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/regcc/week", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/regcc/month", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/regcc/custom", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/regcc/{buildnumber}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
